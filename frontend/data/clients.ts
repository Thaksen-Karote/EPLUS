...
export const clientsData: Client[] = [
  {
    ...
    projectsCompleted: 1,
    keyProjects: ['25 MLD Sewage Treatment Plant at Manesar'],
  },
  {
    id: 'mck',
    ...
    projectsCompleted: 4,
    keyProjects: [
      '6.0 MLD STP Nilokheri',
      '5.5 MLD STP Tarori',
      '8.0 MLD STP Kambopura',
      '11 KV Substation at Kambopura STP',
    ],
  },
  {
    id: 'uprvunl',
    ...
    projectsCompleted: 2,
    keyProjects: [
      '3.0 MLD STP & Sewage Network at OBRA Thermal Power Station',
      '11 KV Substation & 5 KM ACSR Conductor Line Laying',
    ],
  },
  {
    id: 'ntpc',
  ...
  },
  {
    ...
    projectsCompleted: 1,
    keyProjects: ['KEC - Vedanta Admin Building, Odisha'],
  },
  {
    id: 'phd',
    ...
    projectsCompleted: 1,
    keyProjects: ['7.0 MLD Sewage Treatment Plant, Ladwa'],
  },
  {
    id: 'vedanta',
    name: 'Vedanta Group',
    ...
    projectsCompleted: 1,
    keyProjects: ['Vedanta Admin Building Infrastructure'],
  },
  {
    id: 'm3m',
    name: 'M3M India',
    ...
    projectsCompleted: 1,
    keyProjects: ['M3M Golf Estate MEPF Infrastructure'],
  },
  {
    id: 'ish',
    ...
    projectsCompleted: 1,
    keyProjects: ['ISH Campus Interior & Fit-Out'],
  },
];